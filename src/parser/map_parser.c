...
/*   Updated: 2024/02/24 11:32:06 by mde-sa--         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_map(t_map_data **map_data)
{
	...
	map_buffer = get_map_buffer(map_data);
	check_map_chars(map_buffer, map_data);
	get_map_dimensions(map_buffer, map_data);
	printf("Here's the map:\n %s\n", map_buffer);
	create_map_tab(map_buffer, map_data);
	return ;
}
...
void	check_map_chars(char *map_buffer, t_map_data **map_data)
{
	int	i;
	int	start_pos_flag;
...
void	get_map_dimensions(char *map_buffer, t_map_data **map_data)
{
	int		i;
	int		old_newline;
...
void	create_map_tab(char *map_buffer, t_map_data **map_data)
{
	int	i;

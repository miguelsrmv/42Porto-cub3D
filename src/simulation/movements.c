...
/*   Updated: 2024/05/07 13:51:22 by mde-sa--         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	move_foward(t_map_data *map_data, t_vector_data *vector_data)
{
	...
	update_position(map_data, vector_data, foward_vector_x, foward_vector_y);
}
...
void	move_backwards(t_map_data *map_data, t_vector_data *vector_data)
{
	...
	update_position(map_data, vector_data, backwards_vector_x, backwards_vector_y);
}
...
void	move_left(t_map_data *map_data, t_vector_data *vector_data)
{
	...
	leftwards_vector_x = vector_data->vector_dir_y * MOVE_SPEED / TILE_SIZE;
	leftwards_vector_y = -vector_data->vector_dir_x * MOVE_SPEED / TILE_SIZE;
	update_position(map_data, vector_data, leftwards_vector_x, leftwards_vector_y);
}
...
void	move_right(t_map_data *map_data, t_vector_data *vector_data)
{
	...
	rightwards_vector_x = -vector_data->vector_dir_y * MOVE_SPEED / TILE_SIZE;
	rightwards_vector_y = vector_data->vector_dir_x * MOVE_SPEED / TILE_SIZE;
	update_position(map_data, vector_data, rightwards_vector_x, rightwards_vector_y);
}
